const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn Mai Hương năm mới nhiều tiền gặp nhiều anh đẹp trai sớm có ny 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/HH.jpg",    //ảnh pop up đầu
      imageWidth: 320,
      imageHeight: 400,
